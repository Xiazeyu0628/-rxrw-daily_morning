...
# 制作QA data
listNum = len(nounExp)
randomQue = random.randint(0,listNum-1)
answer = list(nounExp.values())[randomQue]
...
data = {
  ...
  "nouns": {
    "value": list(nounExp.keys())[randomQue]
  },
  "answer": {
    "value": "".join(list(nounExp.values())[randomQue])
  }
}
  ...
  try:
    for user_id in user_ids:
      for template in template_ids:
        ...
        res = wm.send_template(user_id, template, data)
        count+=1
